                            ...
                            <h2>Topics</h2>
                                    <h:dataTable value="#{topic.topics}" var="topic" border="1" width="100%">
                                        ...
                                        <h:column>
                                            ...
                                            <h:outputLink value="deletetopic.jsp" onclick="return confirm('Do you want to delete topic and all its questions?','Confirmation')" >
                                            ...
                                            <br/>
                                            <h:outputLink value="surveyresults.jsp">
                                                <h:outputText value="Survey Results"/>
                                                <f:param name="topicid" value="#{topic.id}"/>
                                            </h:outputLink>
                                        </h:column>
                                    </h:dataTable>
